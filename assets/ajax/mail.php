...
try {
    ...
    //Recipients
    $mail->setFrom('info@brilliantwebdesign.co.uk', 'Brilliant Web Design');
    $mail->addAddress('alex_zelea@yahoo.com', 'Alex');     // Add a recipient
    $mail->addAddress('info@brilliantwebdesign.co.uk');               // Name is optional
    $mail->addReplyTo('info@brilliantwebdesign.co.uk', 'Brilliant Web Design');
...
$message = $_POST['message'];
    ...
    $mail->Body    = "First name: $first_name<BR>Phone number: $last_name<BR>Email: $email<BR>Message: $message";
